...
const {userId}=await auth()
      ...
      if(!car) throw new Error("Car not available for test drive")
        ...
        const existingTestDrive=await TestDriveBooking.find({carId:car._id,bookingDate:new Date(bookingDate),startTime:startTime,status:{$in:['PENDING','CONFIRMED']}})
